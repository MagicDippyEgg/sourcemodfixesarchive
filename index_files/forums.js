...
{
	new Ajax.Request( 'https://web.archive.org/web/20240326051612/https://steamcommunity.com/forum/0/0/setpreference', {
...
var CForum = Class.create( {
	...
	UpdateCreateTopicFormDisplay: function()
	{
		...
		if ( this.m_rgCreateTopicFlags !== null && strForumType == 'Trading' )
		{
			...
			strMessage += '<img class="forum_newtopic_info_trade_closebuttondemo" src="https://web.archive.org/web/20240326051612/https://community.cloudflare.steamstatic.com/public/images/skin_1/forum_img_closetopic.png">';
...
function Forum_BlockUser( author, strPersonaName )
{
	ShowConfirmDialog( 'Block All Communication',
		...
		$J.post(
			'https://web.archive.org/web/20240326051612/https://steamcommunity.com/actions/BlockUserAjax',
...
function Forum_OnCommunityAwardGranted( containerNamePrefix, id, award )
{
	...
	if ( rewardsCtn.length != 0 )
	{
		...
		if ( !bFoundExisting )
		{
			...
			var img = $J( "<img>", { class: "community_award_icon tooltip", src: "https://web.archive.org/web/20240326051612/https://store.cloudflare.steamstatic.com/public/images/loyalty/reactions/still/" + award + ".png" } );
			reward.append( img );
...
function Forum_SetMoveTopicClan( clanidowner, appidowner )
{
	...
	if ( rgReloadParams )
	{
		...
		new Ajax.Request( 'https://web.archive.org/web/20240326051612/https://steamcommunity.com/forum/0/General/gettopicdestinations/', {
			method: 'get',
...
{
	var $WaitElem = $J('<div/>', {'class': 'forum_banuser_modal_wait'}).append( '<img src="https://web.archive.org/web/20240326051612/https://community.cloudflare.steamstatic.com/public/images/login/throbber.gif">' );
	...
	$J.get( 'https://web.archive.org/web/20240326051612/https://steamcommunity.com/gid/' + clanid + '/banwarnuserdialog', {
		ajax: 1,
		gidforum: gidForum,
		gidtopic: gidTopic,
		...
		if ( !bWarning )
		{
			...
			Modal.done( function() {
				...
				{
					$J.post(
						'https://web.archive.org/web/20240326051612/https://steamcommunity.com/gid/' + clanid + '/banuser/?ajax=1', $Form.serialize()
...
function Forum_SendPM( clanid, gidForum, gidTopic, gidComment, accountIDTarget )
{
	...
	$modal.done( function( ) {
		...
		$J.post('https://web.archive.org/web/20240326051612/https://steamcommunity.com/gid/' + clanid + '/sendprivatemessage/', rgParams )
...
{
	$J.get( 'https://web.archive.org/web/20240326051612/https://steamcommunity.com/actions/modwarningdialog', { 'sessionID' : g_sessionID, 'steamID' : steamid } )
		.done( function( data )
		{
			var $Content = $J(data);
			var Modal = ShowConfirmDialog( "Issue Warning", $Content, 'Issue Warning'
				...
				$J.post( "https://web.archive.org/web/20240326051612/https://steamcommunity.com/actions/issuemodwarning", $Form.serialize() )
					.done( function( data ) {
...
/*
     FILE ARCHIVED ON 05:16:12 Mar 26, 2024 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 6.659
  LoadShardBlock: 96.762 (3)
  PetaboxLoader3.datanode: 152.637 (5)
  load_resource: 239.613 (2)
  PetaboxLoader3.resolve: 119.433 (2)
*/
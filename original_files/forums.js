...
{
	new Ajax.Request( 'https://web.archive.org/web/20240531060748/https://steamcommunity.com/forum/0/0/setpreference', {
...
var CForum = Class.create( {
	...
	UpdateCreateTopicFormDisplay: function()
	{
		...
		if ( this.m_rgCreateTopicFlags !== null && strForumType == 'Trading' )
		{
			...
			strMessage += '<img class="forum_newtopic_info_trade_closebuttondemo" src="https://web.archive.org/web/20240531060748/https://community.akamai.steamstatic.com/public/images/skin_1/forum_img_closetopic.png">';
...
function Forum_BlockUser( author, strPersonaName )
{
	ShowConfirmDialog( 'Block All Communication',
		...
		$J.post(
			'https://web.archive.org/web/20240531060748/https://steamcommunity.com/actions/BlockUserAjax',
...
function Forum_OnCommunityAwardGranted( containerNamePrefix, id, award )
{
	...
	if ( rewardsCtn.length != 0 )
	{
		...
		if ( !bFoundExisting )
		{
			...
			var img = $J( "<img>", { class: "community_award_icon tooltip", src: "https://web.archive.org/web/20240531060748/https://store.akamai.steamstatic.com/public/images/loyalty/reactions/still/" + award + ".png" } );
			reward.append( img );
...
function Forum_SetMoveTopicClan( clanidowner, appidowner )
{
	...
	if ( rgReloadParams )
	{
		...
		new Ajax.Request( 'https://web.archive.org/web/20240531060748/https://steamcommunity.com/forum/0/General/gettopicdestinations/', {
			method: 'get',
...
{
	var $WaitElem = $J('<div/>', {'class': 'forum_banuser_modal_wait'}).append( '<img src="https://web.archive.org/web/20240531060748/https://community.akamai.steamstatic.com/public/images/login/throbber.gif">' );
	...
	$J.get( 'https://web.archive.org/web/20240531060748/https://steamcommunity.com/gid/' + clanid + '/banwarnuserdialog', {
		ajax: 1,
		gidforum: gidForum,
		gidtopic: gidTopic,
		...
		if ( !bWarning )
		{
			...
			Modal.done( function() {
				...
				{
					$J.post(
						'https://web.archive.org/web/20240531060748/https://steamcommunity.com/gid/' + clanid + '/banuser/?ajax=1', $Form.serialize()
...
function Forum_SendPM( clanid, gidForum, gidTopic, gidComment, accountIDTarget )
{
	...
	$modal.done( function( ) {
		...
		$J.post('https://web.archive.org/web/20240531060748/https://steamcommunity.com/gid/' + clanid + '/sendprivatemessage/', rgParams )
...
{
	$J.get( 'https://web.archive.org/web/20240531060748/https://steamcommunity.com/actions/modwarningdialog', { 'sessionID' : g_sessionID, 'steamID' : steamid } )
		.done( function( data )
		{
			var $Content = $J(data);
			var Modal = ShowConfirmDialog( "Issue Warning", $Content, 'Issue Warning'
				...
				$J.post( "https://web.archive.org/web/20240531060748/https://steamcommunity.com/actions/issuemodwarning", $Form.serialize() )
					.done( function( data ) {
...
/*
     FILE ARCHIVED ON 06:07:48 May 31, 2024 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:28:42 Jul 10, 2025.
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 52.403
  LoadShardBlock: 1253.601 (6)
  PetaboxLoader3.datanode: 541.483 (7)
  PetaboxLoader3.resolve: 580.896 (2)
  load_resource: 99.621
*/
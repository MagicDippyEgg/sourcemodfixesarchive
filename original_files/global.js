...
function checkAbuseSub( elForm )
{
	...
	$J.post( 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/actions/ReportAbuse/', params).done( function() {
...
function RecordAJAXPageView( url )
{
	...
	{
		var rgURLs = [ 'https://web.archive.org/web/20240531060739/https://steamcommunity.com', 'https://web.archive.org/web/20240531060739/https://steamcommunity.com' ];
...
{
    var strURL = 'https://web.archive.org/web/20240531060739/https://avatars.akamai.steamstatic.com/' + hash;
...
{
	$J.get( 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/actions/communitybandialog', { 'sessionID' : g_sessionID, 'steamID' : steamid } )
	.done( function( data )
	{
		var $Content = $J(data);
		var Modal = ShowConfirmDialog( "Community Ban", $Content, 'Submit'
			...
			$J.post( "https://web.archive.org/web/20240531060739/https://steamcommunity.com/actions/StandardCommunityBan", $Form.serialize() )
			.done( function( data ) {
...
{
	var $Content = $J('<div class="group_invite_throbber"><img src="https://web.archive.org/web/20240531060739/https://community.akamai.steamstatic.com/public/images/login/throbber.gif"></div>');
	var $Modal = ShowDialog( null, $Content );
	var sURL = 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/actions/ReportProfile/' + steamID;
	$J.ajax( {
		url: sURL,
		type: 'GET'
	}).done( function ( data ) {
...
function CEmoticonPopup( $EmoticonButton, $Textarea, strBaseURL )
{
	...
	this.m_strBaseURL = strBaseURL || 'https://web.archive.org/web/20240531060739/https://steamcommunity.com';
...
CEmoticonPopup.prototype.BuildPopup = function()
{
	...
	for( var i = 0; i < CEmoticonPopup.sm_rgEmoticons.length; i++ )
	{
		...
		var strEmoticonURL = 'https://web.archive.org/web/20240531060739/https://community.akamai.steamstatic.com/economy/emoticon/' + strEmoticonName;
...
function ShowTradeOffer( tradeOfferID, rgParams )
{
	...
	var strURL = 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/tradeoffer/' + tradeOfferID + '/' + strParams;
...
function Logout()
{
	PostToURLWithSession( 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/login/logout/' );
}

function ChangeLanguage( strTargetLanguage, bStayOnPage )
{
	var Modal = ShowBlockingWaitDialog( 'Change language', '' );
	$J.post( 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/actions/SetLanguage/', {language: strTargetLanguage, sessionid: g_sessionID })
		.done( function() {
			if ( bStayOnPage )
				Modal.Dismiss();
			else
			{
								if( g_steamID )
					window.location = 'https://web.archive.org/web/20240531060739/https://store.steampowered.com/account/languagepreferences/';
...
{
	$J.get( 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/sharedfiles/ajaxeditcontentdescriptors/', { publishedfileid: publishedfileid } )
		.done( function( json ) {
			if ( json.success == 1 )
			{
				...
				dialog.done( function() {
					...
					$J.post(
						'https://web.archive.org/web/20240531060739/https://steamcommunity.com/sharedfiles/ajaxupdatecontentdescriptors/',
...
function UGCAdultContentPreferencesMenu( elSource )
{
	...
	// preferences
	{
		...
		{
			top.location.href = 'https://web.archive.org/web/20240531060739/https://store.steampowered.com//account/preferences/#CommunityContentPreferences';
			return true;
		};
	...
	else
	{
		...
		if ( e.width() > 100 && !e.hasClass( 'ugc_show_warning_image' ) && !e.hasClass( 'dynamiclink_box' ) )
		{
			...
			$elPreferencesOption.click( function ( event )	{
				event.stopPropagation();
				top.location.href = 'https://web.archive.org/web/20240531060739/https://store.steampowered.com/account/preferences';
				return false;
			} );
...
{
	$J.get( 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/comment/' + strCommentThreadType + '/formattinghelp', {ajax:1} ).done( function(data) {
...
CGameSelector = Class.create( {
	...
	OnGameSelectTextEntry: function( elInput, value )
	{
		if ( value )
		{
			new Ajax.Request( 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/actions/SearchApps/' + encodeURIComponent( value ), {
				method: 'get',
...
CGameSelectorWorkshopGames = Class.create( CGameSelector, {
	OnGameSelectTextEntry: function( elInput, value )
	{
		if ( value )
		{
			new Ajax.Request( 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/workshop/ajaxfindworkshops/?searchText=' + encodeURIComponent( value ), {
				method: 'get',
				onSuccess: this.ReceiveGameSelectResponse.bind( this, value )
			} );
		}
...
CGameSelectorOwnedGames = Class.create( CGameSelector, {
	...
	OnGameSelectTextEntry: function( elInput, value )
	{
		if ( value )
		{
			...
			{
				this.elSuggestions.update( '<div style="text-align: center; width: 200px; padding: 5px 0;"><img src="https://web.archive.org/web/20240531060739/https://community.akamai.steamstatic.com/public/images/login/throbber.gif"></div>' );
				this.bHaveSuggestions = true;
				this.ShowSuggestions();
			}
			else
...
CGameSelectorOwnedGames.LoadOwnedGames = function( fnCallback )
{
	if ( !CGameSelectorOwnedGames.AreOwnedGamesLoaded() )
	{
		...
		new Ajax.Request( 'https://web.archive.org/web/20240531060739/https://steamcommunity.com/actions/GetOwnedApps/', {
			method: 'get',
			parameters: rgParams,
...
{
	var newImgPath = "https://web.archive.org/web/20240531060739/https://community.akamai.steamstatic.com/public/images/" + newImg;
	setImage( imgID, newImgPath );
}
...
{
	gShareRequestURL = "https://web.archive.org/web/20240531060739/https://steamcommunity.com/sharedfiles/shareonsteam/?id=" + publishedFileID + '&appid=' + appID;

	var shareURL = "https://web.archive.org/web/20240531060739/https://steamcommunity.com/sharedfiles/filedetails/?id=" + publishedFileID;
	var baseSocialShareURL = "https://web.archive.org/web/20240531060739/https://steamcommunity.com/sharedfiles/share/?id=" + publishedFileID;
	ShowSharePopup( shareURL, baseSocialShareURL );
}

function ShowShareNewsPostPopup( gid, appid )
{
	gShareRequestURL = "https://web.archive.org/web/20240531060739/https://steamcommunity.com/news/shareonsteam/" + gid + "?appid=" + appid;

	var baseSocialShareURL = "https://web.archive.org/web/20240531060739/https://steamcommunity.com/news/sharepost/" + gid;
	var shareURL = "https://web.archive.org/web/20240531060739/https://steamcommunity.com/news/post/" + gid;
	ShowSharePopup( shareURL, baseSocialShareURL );
}

function ShowShareClanAnnouncementPopup( groupId, gid )
{
	gShareRequestURL = "https://web.archive.org/web/20240531060739/https://steamcommunity.com/gid/" + groupId + "/announcements/shareonsteam/" + gid;

	var baseSocialShareURL = "https://web.archive.org/web/20240531060739/https://steamcommunity.com/gid/" + groupId + "/announcements/share/" + gid;
	var shareURL = "https://web.archive.org/web/20240531060739/https://steamcommunity.com/gid/" + groupId + "/announcements/detail/" + gid;
	ShowSharePopup( shareURL, baseSocialShareURL );
}
...
/*
     FILE ARCHIVED ON 06:07:39 May 31, 2024 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:28:38 Jul 10, 2025.
...
playback timings (ms):
  ...
  esindex: 0.029
  cdx.remote: 64.185
  LoadShardBlock: 170.254 (3)
  PetaboxLoader3.datanode: 151.096 (4)
  load_resource: 682.665
  PetaboxLoader3.resolve: 189.12
*/
...
function OpenFriendChat( steamid, accountid )
{
	...
	{
				window.location = 'https://web.archive.org/web/20240531060743/https://steamcommunity.com/chat/friend/' + steamid;
	}
...
function OpenGroupChat( steamid )
{
	...
	{
				window.location = 'https://web.archive.org/web/20240531060743/https://steamcommunity.com/chat/group/' + steamid;
	}
	...
	ShowConfirmDialog( 'Got Steam?', 'We couldn\'t find Steam running on your machine.  Would you like to launch web chat?',
		'Use web chat' , null, 'Get Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				...
				window.location = 'https://web.archive.org/web/20240531060743/https://store.steampowered.com/about/'
	});
}
...
{
	var rgParams = { url: 'https://web.archive.org/web/20240531060743/https://steamcommunity.com/' + path };
	if ( method )
		rgParams.type = method;

	// if this js file was hosted off the store, add CORS request headers
	if ( window.location.href.indexOf( 'https://web.archive.org/web/20240531060743/https://steamcommunity.com/' ) != 0 )
	{
...
function InitCookiePreferencesPopup()
{
	...
	{
		$AllowURL = encodeURI( 'https://web.archive.org/web/20240531060743/https://store.steampowered.com/' + 'account/ajaxsetcookiepreferences');
...
{
	return {
		url: 'https://web.archive.org/web/20240531060743/https://community.akamai.steamstatic.com/' + this.m_strURL,
		dataType: 'jsonp',
...
{
	var el = $J(elem);
	var youtubeurl = location.protocol + '//web.archive.org/web/20240531060743/https://www.youtube.com/embed/' + videoid + '?showinfo=0&autohide=1&fs=1&hd=1&modestbranding=1&rel=0&showsearch=0&wmode=direct&autoplay=1';
...
{
	var el = $J(elem);
	var videourl = 'https://web.archive.org/web/20240531060743/https://player.vimeo.com/video/' + videoid + '?badge=0&autopause=0&autoplay=1&player_id=0';
	var wrapper = $J( '<div/>', { 'class': 'dynamiclink_youtubeviewvideo' } );
	var embed_wrapper = $J( '<div/>', { 'class' : 'dynamiclink_youtubeviewvideoembedded', 'frameborder' : '0' } );
...
{
	var url = "https://web.archive.org/web/20240531060743/https://sketchfab.com/models/" + details.modelid + "/embed?autostart=1";
	var el = $J(elem);
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Error',
					'Your account does not meet the requirements to use this feature. <a class="whiteLink" href="https://web.archive.org/web/20240531060743/https://help.steampowered.com/en/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Visit Steam Support</a> for more information.'
				);
				break;
			case 15:
...
function LaunchWebChat( params, paramsFriendsUI )
{
	...
	if ( bNewPopup )
	{
		...
		if ( paramsFriendsUI )
		{
			var fnBoundMessageListener = function( event )
			{
				if ( event.source == winChat && event.data == "FriendsUIReady" &&
					event.origin == 'https://web.archive.org/web/20240531060743/https://steamcommunity.com')
				{
					winChat.postMessage( paramsFriendsUI, 'https://web.archive.org/web/20240531060743/https://steamcommunity.com/' );
		...
		winChat.location = 'https://web.archive.org/web/20240531060743/https://steamcommunity.com/chat/';
	}
	else
	{
...
function LockFamilyView( bStore )
{
	...
	if ( bStore )
	{
		urlFirst = 'https://web.archive.org/web/20240531060743/https://store.steampowered.com/';
		urlSecond = 'https://web.archive.org/web/20240531060743/https://steamcommunity.com/';
	}
	else
	{
		urlFirst = 'https://web.archive.org/web/20240531060743/https://steamcommunity.com/';
		urlSecond = 'https://web.archive.org/web/20240531060743/https://store.steampowered.com/';
	}
	...
	ShowConfirmDialog( 'Return to Family View',
		...
		CrossDomainPost( urlFirst + '/parental/ajaxlock', {} ).then( function() {
			$J.when(
									CrossDomainPost( 'https://web.archive.org/web/20240531060743/https://checkout.steampowered.com/parental/ajaxlock', {} ),
								CrossDomainPost( 'https://web.archive.org/web/20240531060743/https://steam.tv/parental/ajaxlock', {} ),
...
function ViewTitlesWithDescriptors( descid )
{
	...
	$J.get( 'https://web.archive.org/web/20240531060743/https://store.steampowered.com/search/results/',
		{
...
/*
     FILE ARCHIVED ON 06:07:43 May 31, 2024 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:28:39 Jul 10, 2025.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 158.394
  LoadShardBlock: 364.017 (6)
  PetaboxLoader3.datanode: 354.56 (7)
  load_resource: 91.942
*/